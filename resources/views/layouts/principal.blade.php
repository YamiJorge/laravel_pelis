...
<div class="full">
    ...
    <div class="main">
        ...
        @yield('content') {{-- @yield va a buscar una sección establecida en la página (o vista) actual
        y la va a mostrar en ese lugar. Se le puede agregar también un valor por defecto en caso que
        no haya nada en dicha sección. --}}
